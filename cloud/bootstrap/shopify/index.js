...
module.exports = {
  bootstrap(app) {
    ...
    shopifyAuthNode.bootstrap({
      app,
      shopifyAppScopes:
        "read_checkouts,read_price_rules,write_price_rules,read_discounts,write_discounts,read_products,read_product_listings,read_orders,read_script_tags,write_script_tags",
